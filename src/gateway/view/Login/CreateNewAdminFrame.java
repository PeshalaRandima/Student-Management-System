 ...
 * @author Pesshala
 */
public class CreateNewAdminFrame extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public CreateNewAdminFrame() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateNewAdminFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateNewAdminFrame().setVisible(true);
            }
        });
    }
